...
module \$paramod$4e3c9597c46142db96bf5cf974f87cb414ae3567\axi4_to_ahb (clk, rst_n, s_awvalid, s_awready, s_awaddr, s_awid, s_wvalid, s_wready, s_wdata, s_wstrb, s_bvalid, s_bready, s_bresp, s_bid, s_arvalid, s_arready, s_araddr, s_arid, s_rvalid, s_rready, s_rdata
...
, spi_miso, spi_csn, i2c_scl, i2c_sda, harts_active, link_up_pcie);
  ...
  \$paramod$4e3c9597c46142db96bf5cf974f87cb414ae3567\axi4_to_ahb  u_axi2ahb (
    .clk(sys_clk),
    .haddr(ahb_haddr),
    .hrdata(ahb_hrdata),
    .hready(ahb_hready),
