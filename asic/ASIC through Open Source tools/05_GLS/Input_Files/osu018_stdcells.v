...
reg NOTIFIER ;
    ...
    wire D_AND_S, NOT_D_AND_R, S_AND_R;
    wire D_, P0002, P0003, I0_CLEAR, I0_SET, I7_out;
    ...
    specify
      ...
      (S *> Q) = (tphlh$S$Q, 0);
      $setup(negedge D, posedge CLK &&& S_AND_R , tsetup_negedge$D$CLK, NOTIFIER);
      $hold (negedge D, posedge CLK &&& S_AND_R , thold_negedge$D$CLK,  NOTIFIER);
      $setup(posedge D, posedge CLK &&& S_AND_R , tsetup_posedge$D$CLK, NOTIFIER);
      $hold (posedge D, posedge CLK &&& S_AND_R , thold_posedge$D$CLK,  NOTIFIER);
      $recovery(posedge R, posedge CLK &&& D_AND_S , trec$R$CLK, NOTIFIER);
      $removal (posedge R, posedge CLK &&& D_AND_S , trem$R$CLK, NOTIFIER);
      $recovery(posedge R, posedge S, trec$R$S, NOTIFIER);
      $recovery(posedge S, posedge CLK &&& NOT_D_AND_R , trec$S$CLK, NOTIFIER);
      $removal (posedge S, posedge CLK &&& NOT_D_AND_R , trem$S$CLK, NOTIFIER);
